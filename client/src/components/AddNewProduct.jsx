  ...
  return (
    <Tr>
      <Td>
        ...
        <Tooltip label={'Set the name of your image e.g., Pasta.jpg'} fontSize='sm'>
          <Input size='sm' value={image} onChange={(e) => setImage(e.target.value)} placeholder='e.g., Pasta.jpg' />
        </Tooltip>
      </Td>
      <Td>
      ...
      <Td>
        ...
        <Input size='sm' value={brand} onChange={(e) => setBrand(e.target.value)} placeholder='Pocky or Kikkoman etc.' />
        <Text fontSize='sm'>Name</Text>
        <Input size='sm' value={name} onChange={(e) => setName(e.target.value)} placeholder='Soy Sauce' />
      </Td>

      <Td>
        <Text fontSize='sm'>Category</Text>
        <Input size='sm' value={category} onChange={(e) => setCategory(e.target.value)} placeholder='Mochi' />
        <Text fontSize='sm'>Price</Text>
        <Input size='sm' value={price} onChange={(e) => setPrice(e.target.value)} placeholder='1000 Ft' />
      </Td>
